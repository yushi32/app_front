    ...
    <div className="flex-grow max-w-5xl mx-auto pt-12 pb-16 space-y-14 text-neutral-700">
      <div className="border-b-2">
        ...
        <p className="py-4 text-sm">
          この利用規約（以下、「本規約」といいます。）は、Laterless（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザー（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>
      </div>
      <div>
        ...
        <ol className="list-decimal space-y-2 ml-4 text-sm">
          <li>
      ...
      <div>
        ...
        <ul className="list-decimal space-y-2 ml-4 text-sm">
          <li>
      ...
      <div>
        ...
        <ol className="list-decimal space-y-2 ml-4 text-sm">
          <li>
            当方は、ユーザーが以下のいずれかに該当する場合には、事前の通知なく、投稿データを削除し、ユーザーに対して本サービスの全部もしくは一部の利用を制限し、またはユーザーとしての登録を抹消することができるものとします。
            <ul className="list-disc space-y-1 mt-2 ml-4">
              <li>
                本規約のいずれかの条項に違反した場合
              </li>
